...
BlogPostParagraph.Bold = ({ children, className, ...props }: BlogPostParagraphProps) => (
  <BlogPostParagraph className={`font-medium ${className || ''}`} {...props}>
    {children}
  </BlogPostParagraph>
)

BlogPostParagraph.Code = ({ children, className, ...props }: BlogPostParagraphProps) => (
  <code 
    className={`
...
BlogPostParagraph.Underline = ({ children, className, ...props }: BlogPostParagraphProps) => (
  <BlogPostParagraph 
    className={`
...
BlogPostParagraph.Italic = ({ children, className, ...props }: BlogPostParagraphProps) => (
  <BlogPostParagraph 
    className={`
...
BlogPostParagraph.Link = ({ children, className, ...props }: BlogPostParagraphProps) => (
  <BlogPostParagraph 
    className={`
      font-medium 
      underline decoration-textDark/70 
