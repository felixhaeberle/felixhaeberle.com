        ...
        <r-grid columns="6">
          <r-cell span="3" span-m="4" span-s="6">
            ...
            <ul className="m-0 mb-unit list-none">
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">Besuchte Seite auf unserer Domain</Text.Small.Dark></li>
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">Datum und Uhrzeit der Serveranfrage</Text.Small.Dark></li>
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">Browsertyp und Browserversion</Text.Small.Dark></li>
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">Verwendetes Betriebssystem</Text.Small.Dark></li>
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">Referrer URL</Text.Small.Dark></li>
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">Hostname des zugreifenden Rechners</Text.Small.Dark></li>
                <li><Text.Small.Dark className="indent-0 mb-0 before:content-['-'] before:pr-[5px]">IP-Adresse</Text.Small.Dark></li>
            </ul>
            ...
            <Text.Small.Dark>Einzelheiten zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von YouTube unter: <a href="https://www.google.de/intl/de/policies/privacy" className="text-textDarker transition-opacity duration-220 break-words hover:opacity-90">https://www.google.de/intl/de/policies/privacy</a>.</Text.Small.Dark>
            ...
            <Text.Small.Dark>Einzelheiten zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von Vimeo unter: <a href="https://vimeo.com/privacy" className="text-textDarker transition-opacity duration-220 break-words hover:opacity-90">https://vimeo.com/privacy</a>.</Text.Small.Dark>
            ...
            <Text.Small.Dark>Bei Nutzung von Twitter und der Funktion "Re-Tweet" werden von Ihnen besuchte Websites mit Ihrem Twitter-Account verknüpft und in Ihrem Twitter-Feed veröffentlicht. Dabei erfolgt eine Übermittlung von Daten an Twitter. Über den Inhalt der übermittelten
              Daten sowie die Nutzung dieser Daten durch Twitter haben wir keine Kenntnis. Einzelheiten finden Sie in der Datenschutzerklärung von Twitter: <a href="https://twitter.com/privacy" className="text-textDarker transition-opacity duration-220 break-words hover:opacity-90">https://twitter.com/privacy</a>.</Text.Small.Dark>
            <Text.Small.Dark>Sie können Ihre Datenschutzeinstellungen bei Twitter ändern: <a href="https://twitter.com/account/settings" className="text-textDarker transition-opacity duration-220 break-words hover:opacity-90">https://twitter.com/account/settings</a></Text.Small.Dark>
            ...
            <Text.Small.Dark>Einzelheiten über Google Web Fonts finden Sie unter: <a href="https://www.google.com/fonts#AboutPlace:about" className="text-textDarker transition-opacity duration-220 break-words hover:opacity-90">https://www.google.com/fonts#AboutPlace:about</a> und weitere Informationen in den Datenschutzbestimmungen von Google: <a href="https://policies.google.com/privacy/partners?hl=de" className="text-textDarker transition-opacity duration-220 break-words hover:opacity-90">https://policies.google.com/privacy/partners?hl=de</a></Text.Small.Dark>
          </r-cell>
        </r-grid>
      </main>
    </Layout>
